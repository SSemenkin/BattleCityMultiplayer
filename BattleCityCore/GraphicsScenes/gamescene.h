...
#include "GraphicsSceneObjects/staticbody.h"
#include "level.h"

class BATTLECITYCORE_EXPORT GameScene : public QGraphicsScene
{
    Q_OBJECT
public:
...
protected:
    ...
    QVector<GameObject *> m_scoreItems;
    QVector<GameObject *> m_enemiesLives;

    QVector<GameObject *> m_hides;
    QVector<GameObject *> m_border;
...
private:
    ...
    void initInterface();
    void spawnExplosionAt(GameObject *gameObject);
    void enemyDestroyed();
    void rebuildScore();
    void showScore();

    void hideGameObjectAndCreateConcrete(const QPointF &nearPos);
